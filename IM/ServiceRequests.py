...
class Request_GetVMProperty(IMBaseRequest):
	...
	def _call_function(self):
		...
		return InfrastructureManager.InfrastructureManager.GetVMProperty(inf_id, vm_id, property_name, Authentication(auth_data))
...
class Request_ExportInfrastructure(IMBaseRequest):
	...
	def _call_function(self):
		...
		return InfrastructureManager.InfrastructureManager.ExportInfrastructure(inf_id, delete, Authentication(auth_data))
