...
def RESTDestroyInfrastructure(infid=None):
    ...
    try:
        ...
        return return_error(404, "Error Destroying Inf: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error Destroying Inf: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error Destroying Inf: %s" % ", ".join(ex.args))
    except Exception as ex:
        logger.exception("Error Destroying Inf")
        return return_error(400, "Error Destroying Inf: %s" % ", ".join(ex.args))
...
def RESTGetInfrastructureInfo(infid=None):
    ...
    try:
        ...
        return return_error(404, "Error Getting Inf. info: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error Getting Inf. info: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error Getting Inf. info: %s" % ", ".join(ex.args))
    except Exception as ex:
        logger.exception("Error Getting Inf. info")
        return return_error(400, "Error Getting Inf. info: %s" % ", ".join(ex.args))
...
def RESTGetInfrastructureProperty(infid=None, prop=None):
    ...
    try:
        ...
        return return_error(404, "Error Getting Inf. prop: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error Getting Inf. prop: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error Getting Inf. prop: %s" % ", ".join(ex.args))
    except Exception as ex:
        logger.exception("Error Getting Inf. prop")
        return return_error(400, "Error Getting Inf. prop: %s" % ", ".join(ex.args))
...
def RESTGetInfrastructureList():
    ...
    try:
        ...
        return return_error(401, "Error Getting Inf. List: %s" % ", ".join(ex.args))
    except Exception as ex:
        logger.exception("Error Getting Inf. List")
        return return_error(400, "Error Getting Inf. List: %s" % ", ".join(ex.args))
...
def RESTCreateInfrastructure():
    ...
    try:
        ...
        return return_error(401, "Error Getting Inf. info: %s" % ", ".join(ex.args))
    except Exception as ex:
        logger.exception("Error Creating Inf.")
        return return_error(400, "Error Creating Inf.: %s" % ", ".join(ex.args))
...
def RESTImportInfrastructure():
    ...
    try:
        ...
        return return_error(401, "Error Impporting Inf.: %s" % ", ".join(ex.args))
    except Exception as ex:
        logger.exception("Error Impporting Inf.")
        return return_error(400, "Error Impporting Inf.: %s" % ", ".join(ex.args))
...
def RESTGetVMInfo(infid=None, vmid=None):
    ...
    try:
        ...
        return return_error(404, "Error Getting VM. info: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error Getting VM. info: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error Getting VM. info: %s" % ", ".join(ex.args))
        ...
        return return_error(400, "Error Getting VM info: %s" % ", ".join(ex.args))
...
def RESTGetVMProperty(infid=None, vmid=None, prop=None):
    ...
    try:
        ...
        return return_error(404, "Error Getting VM. property: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error Getting VM. property: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error Getting VM. property: %s" % ", ".join(ex.args))
    except DeletedVMException as ex:
        return return_error(404, "Error Getting VM. property: %s" % ", ".join(ex.args))
    except IncorrectVMException as ex:
        return return_error(404, "Error Getting VM. property: %s" % ", ".join(ex.args))
        ...
        return return_error(400, "Error Getting VM property: %s" % ", ".join(ex.args))
...
def RESTAddResource(infid=None):
    ...
    try:
        ...
        return return_error(404, "Error Adding resources: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error Adding resources: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error Adding resources: %s" % ", ".join(ex.args))
    except Exception as ex:
        logger.exception("Error Adding resources")
        return return_error(400, "Error Adding resources: %s" % ", ".join(ex.args))
...
def RESTRemoveResource(infid=None, vmid=None):
    ...
    try:
        ...
        return return_error(404, "Error Removing resources: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error Removing resources: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error Removing resources: %s" % ", ".join(ex.args))
    except DeletedVMException as ex:
        return return_error(404, "Error Removing resources: %s" % ", ".join(ex.args))
    except IncorrectVMException as ex:
        return return_error(404, "Error Removing resources: %s" % ", ".join(ex.args))
        ...
        return return_error(400, "Error Removing resources: %s" % ", ".join(ex.args))
...
def RESTAlterVM(infid=None, vmid=None):
    ...
    try:
        ...
        return return_error(404, "Error modifying resources: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error modifying resources: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error modifying resources: %s" % ", ".join(ex.args))
    except DeletedVMException as ex:
        return return_error(404, "Error modifying resources: %s" % ", ".join(ex.args))
    except IncorrectVMException as ex:
        return return_error(404, "Error modifying resources: %s" % ", ".join(ex.args))
        ...
        return return_error(400, "Error modifying resources: %s" % ", ".join(ex.args))
...
def RESTReconfigureInfrastructure(infid=None):
    ...
    try:
        ...
        return return_error(404, "Error reconfiguring infrastructure: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error reconfiguring infrastructure: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error reconfiguring infrastructure: %s" % ", ".join(ex.args))
    except Exception as ex:
        logger.exception("Error reconfiguring infrastructure")
        return return_error(400, "Error reconfiguring infrastructure: %s" % ", ".join(ex.args))
...
def RESTStartInfrastructure(infid=None):
    ...
    try:
        ...
        return return_error(404, "Error starting infrastructure: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error starting infrastructure: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error starting infrastructure: %s" % ", ".join(ex.args))
    except Exception as ex:
        logger.exception("Error starting infrastructure")
        return return_error(400, "Error starting infrastructure: %s" % ", ".join(ex.args))
...
def RESTStopInfrastructure(infid=None):
    ...
    try:
        ...
        return return_error(404, "Error stopping infrastructure: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error stopping infrastructure: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error stopping infrastructure: %s" % ", ".join(ex.args))
    except Exception as ex:
        logger.exception("Error stopping infrastructure")
        return return_error(400, "Error stopping infrastructure: %s" % ", ".join(ex.args))
...
def RESTStartVM(infid=None, vmid=None):
    ...
    try:
        ...
        return return_error(404, "Error starting VM: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error starting VM: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error starting VM: %s" % ", ".join(ex.args))
    except DeletedVMException as ex:
        return return_error(404, "Error starting VM: %s" % ", ".join(ex.args))
    except IncorrectVMException as ex:
        return return_error(404, "Error starting VM: %s" % ", ".join(ex.args))
        ...
        return return_error(400, "Error starting VM: %s" % ", ".join(ex.args))
...
def RESTStopVM(infid=None, vmid=None):
    ...
    try:
        ...
        return return_error(404, "Error stopping VM: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error stopping VM: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error stopping VM: %s" % ", ".join(ex.args))
    except DeletedVMException as ex:
        return return_error(404, "Error stopping VM: %s" % ", ".join(ex.args))
    except IncorrectVMException as ex:
        return return_error(404, "Error stopping VM: %s" % ", ".join(ex.args))
        ...
        return return_error(400, "Error stopping VM: %s" % ", ".join(ex.args))
...
def RESTRebootVM(infid=None, vmid=None):
    ...
    try:
        ...
        return return_error(404, "Error rebooting VM: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error rebooting VM: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error rebooting VM: %s" % ", ".join(ex.args))
    except DeletedVMException as ex:
        return return_error(404, "Error rebooting VM: %s" % ", ".join(ex.args))
    except IncorrectVMException as ex:
        return return_error(404, "Error rebooting VM: %s" % ", ".join(ex.args))
        ...
        return return_error(400, "Error rebooting VM: %s" % ", ".join(ex.args))
...
def RESTGeVersion():
    try:
        ...
        return return_error(400, "Error getting IM version: %s" % ", ".join(ex.args))
...
def RESTCreateDiskSnapshot(infid=None, vmid=None, disknum=None):
    ...
    try:
        ...
        return return_error(404, "Error creating snapshot: %s" % ", ".join(ex.args))
    except IncorrectInfrastructureException as ex:
        return return_error(404, "Error creating snapshot: %s" % ", ".join(ex.args))
    except UnauthorizedUserException as ex:
        return return_error(403, "Error creating snapshot: %s" % ", ".join(ex.args))
    except DeletedVMException as ex:
        return return_error(404, "Error creating snapshot: %s" % ", ".join(ex.args))
    except IncorrectVMException as ex:
        return return_error(404, "Error creating snapshot: %s" % ", ".join(ex.args))
        ...
        return return_error(400, "Error creating snapshot: %s" % ", ".join(ex.args))
