...
from IM.tosca.toscaparser.capabilities import Capability
...
from IM.tosca.toscaparser.common.exception import ValidationError
from IM.tosca.toscaparser.elements.interfaces import InterfacesDef
from IM.tosca.toscaparser.elements.nodetype import NodeType
from IM.tosca.toscaparser.elements.relationshiptype import RelationshipType
from IM.tosca.toscaparser.properties import Property
...
class EntityTemplate(object):
    ...
    SECTIONS = (DERIVED_FROM, PROPERTIES, REQUIREMENTS,
               ...
               ('derived_from', 'properties', 'requirements', 'interfaces',
                ...
                'attributes', 'artifacts', 'node_filter', 'copy')
    # Miguel: Add NODE_FILTER to the REQUIREMENTS_SECTION
