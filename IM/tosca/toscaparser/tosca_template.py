...
from IM.tosca.toscaparser.common.exception import InvalidTemplateVersion
from IM.tosca.toscaparser.common.exception import MissingRequiredFieldError
from IM.tosca.toscaparser.common.exception import UnknownFieldError
from IM.tosca.toscaparser.topology_template import TopologyTemplate
from IM.tosca.toscaparser.tpl_relationship_graph import ToscaGraph
from IM.tosca.toscaparser.utils.gettextutils import _
import IM.tosca.toscaparser.utils.urlutils
import IM.tosca.toscaparser.utils.yamlparser
...
YAML_LOADER = IM.tosca.toscaparser.utils.yamlparser.load_yaml
        ...
        if imports:
            ...
            for definition in imports:
                ...
                if main_a_file:
                    ...
                    a_url = IM.tosca.toscaparser.utils.urlutils.UrlUtils.\
                    ...
                    if not a_url:
                        if os.path.isabs(definition):
                            raise ImportError(_("Absolute file name cannot be "
                                                ...
                                                "template."))
                        def_file = IM.tosca.toscaparser.utils.urlutils.UrlUtils.\
