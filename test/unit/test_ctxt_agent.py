...
class TestCtxtAgent(unittest.TestCase):
    ...
    def test_95_install_ansible_modules(self):
        ...
        copy_content = yaml.safe_load(yaml_data[0]['tasks'][1]['copy'][pos+9:-2])
        self.assertEqual(copy_content[0], {'src': 'ansible_role'})
        self.assertEqual(copy_content[1], {'name': 'hadoop', 'src': 'git+https://github.com/micafer/ansible-role-hadoop'}) 
