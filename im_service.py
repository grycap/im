...
def StopInfrastructure(inf_id, auth_data):
	request = IMBaseRequest.create_request(IMBaseRequest.STOP_INFRASTRUCTURE,(inf_id, auth_data)) 
	return WaitRequest(request)
...
def GetInfrastructureRADL(inf_id, auth_data):
	request = IMBaseRequest.create_request(IMBaseRequest.GET_INFRASTRUCTURE_RADL,(inf_id, auth_data)) 
	return WaitRequest(request)
