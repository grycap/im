...
python setup.py --command-packages=stdeb.command sdist_dsc --depends "python-radl, ansible, python-paramiko, python-yaml, python-soappy, python-boto, python-libcloud, python-bottle, python-netaddr, python-scp, python-cherrypy3" bdist_deb
mkdir dist_pkg
